...
test=np.arange(0.001, 0.021, 0.001)
...
plt.plot(test, y)
plt.plot(test, y, 'o')
plt.title("polonio, mantengo pixel costante")
plt.xlabel("L")
plt.ylabel("eff")
plt.show()
...
plt.plot(test, y)
plt.plot(test, y, 'o')
plt.title("polonio, mantengo fenditura costante")
plt.xlabel("L")
plt.ylabel("eff")
plt.show()
...
plt.plot(test, y)
plt.plot(test, y, 'o')
plt.title("polonio, vario simultaneamente pixel e fenditura")
plt.xlabel("L")
plt.ylabel("eff")
plt.show()
